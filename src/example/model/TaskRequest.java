...
public class TaskRequest {
	...
	public TaskRequest update() throws SQLException {
	...
	public static List<TaskRequest> getAll(UUID userID) throws SQLException {
	...
	public static TaskRequest get(UUID id) throws SQLException {
